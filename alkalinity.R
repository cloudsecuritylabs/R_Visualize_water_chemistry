d=read.csv("alkalinity.csv",header=T,sep=",",stringsAsFactors=FALSE)
...
mtext("Alkalinity trend in the various sample groups during the leach test study", side = 3, line = -2, outer = TRUE, cex=1.2)
