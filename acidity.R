d=read.csv("acidity.csv",header=T,sep=",",stringsAsFactors=FALSE)
...
mtext("Acidity trend in the various sample groups during the leach test study", side = 3, line = -2, outer = TRUE, cex=1.2)
