d=read.csv("cond.csv",header=T,sep=",",stringsAsFactors=FALSE)
...
mtext("Conductivity trend in the various sample groups during the leach test study", side = 3, line = -2, outer = TRUE, cex=1.2)
